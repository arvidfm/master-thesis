...
This \namecref{ch:methods} provides an overview of topics that serve as a base for the rest of the thesis.
...
\begin{equation}
\boldsymbol \theta^{t+1} \gets \boldsymbol \theta^t - \eta\frac{\partial}{\partial \boldsymbol \theta}\left(\frac{1}{B} \sum_{i=1}^B L(\mat \theta^t; \mat x_i, \mat y_i)\right)
\end{equation}
