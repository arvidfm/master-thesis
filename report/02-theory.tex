...
\begin{figure}
  \begin{center}
    \include{figures/stft}
  \end{center}
  \caption{\label{fig:sftf}Short-time Fourier transform}
\end{figure}
...
\begin{figure}
  \begin{center}
    \include{figures/mel-filterbank}
  \end{center}
  \caption{\label{fig:filterbank} Filter bank}
\end{figure}
...
\begin{figure}[p]
  \begin{center}
    \include{figures/separability}
  \end{center}
  \caption{\label{fig:separability}Separability}
\end{figure}
...
\begin{figure}
  \begin{center}
    \include{figures/feedforward}
  \end{center}
  \caption{\label{fig:feedforward}Feedforward network}
\end{figure}
...
%
g^2(z) &= z &
\mat W^2 &= \left(\begin{matrix}0.5 \\ 0.5\end{matrix}\right) &
b^2 &= -0.1 \\
\end{align*}
