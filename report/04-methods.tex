...
\todo[inline]{define allophone/phoneme?}
...
$\alpha$ is a hyperparameter specifying how much more to weigh the different-class loss over the same-class loss.

\todo[inline]{does the below paragraph make sense without having read the entropy penalty section?}
