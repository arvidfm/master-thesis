...
\end{tikzpicture}
 ...
 \caption{\label{fig:entropy-penalty} \textbf{Left:} Average normalised entropy of the output distribution over the validation samples and Jensen-Shannon loss (combined, same-class and different-class) as a function of the entropy penalty $\lambda$ for the English and Xitsonga.
