...
\citeauthor{versteegh2015zero} recently introduced the Zero Resource Speech Challenge \parencite{versteegh2015zero}, which was developed with the goal of standardising these endeavours. %finding linguistic units (track 1) or longer recurring word-like fragments (track 2) in speech.
